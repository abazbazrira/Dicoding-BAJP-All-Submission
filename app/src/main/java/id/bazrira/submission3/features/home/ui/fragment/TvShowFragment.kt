...
import id.bazrira.submission3.databinding.FragmentTvShowBinding
...
class TvShowFragment : DaggerFragment(), ItemCallback {
  ...
  private fun setListData() {
    viewModel.getListTvShow().observe(viewLifecycleOwner, { listData ->
      if (listData != null) {
