...
object DataDummy {
  ...
  fun generateDataMovieDummyResponse(): ArrayList<MovieResponse> {
    val listItemData = ArrayList<MovieResponse>()
  ...
  fun generateDataTvShowDummyResponse(): ArrayList<TvShowResponse> {
    val listItemData = ArrayList<TvShowResponse>()

    listItemData.add(
      TvShowResponse(
        id = 1,
        title = "Dragon Ball Z",
        desc = "Five years have passed since the fight with Piccolo Jr., and Goku now has a son, Gohan. The peace is interrupted when an alien named Raditz arrives on Earth in a spacecraft and tracks down Goku, revealing to him that that they are members of a near-extinct warrior race called the Saiyans.",
        poster = "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/dBsDWUcdfbuZwglgyeeQ9ChRoS4.jpg",
        backDrop = "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/y1DQTFlJAn8mhDQx9PMUfYTO78j.jpg"
      )
    )
  ...
  fun generateDataMovieDummy(): ArrayList<ItemData> {
    val listItemData = ArrayList<ItemData>()
  ...
  fun generateDataTvShowDummy(): ArrayList<ItemData> {
    val listItemData = ArrayList<ItemData>()
